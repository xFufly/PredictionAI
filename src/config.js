const hiddenNodes = 332; // Number of hidden layers
...
const learningRate = 1; // Should it try itself to find the answer ?
const epochs = 332; // Number of "steps" to try to correct its mistakes
